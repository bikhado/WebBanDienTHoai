...
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> + ĐIỆN THOẠI </a>
				<ul>
                    <%
                        for (i = 1; i <= tools.getSoLuongNSX().Rows.Count; i++)
                        {                      
                    %>
				<li><a class="active" href="products.html"><i class="icon-chevron-right"></i><% = tools.getTenNSX(Convert.ToString(i)) %></a></li>
				    <%
                        } 
                    %>
				</ul>
...
<!-- Sidebar end=============================================== -->
		...
		<h4>Sản Phẩm Mới Nhất </h4>
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
					<a  href="product_details.html"><img src="<%= tools.getSanPham().Rows[i]["urlHinh"].ToString() %>" alt="" width="160" height="160"/></a>
					<div class="caption">
					  <h5><%= tools.getSanPham().Rows[i]["tenSP"].ToString() %></h5>
                        ...
                        <% else %> 
					  <p> 
						<a class="btn btn-primary" href="#"><%= tools.formatMoney(tools.getSanPham().Rows[i]["GiaHienTai"].ToString(),".") + " " + "đ" %></a>
					  </p>				 
